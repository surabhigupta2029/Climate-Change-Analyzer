...
interface IWeatherIO {
	 ...
	 public void writeSubjectHeaderInFile(String filename, String subject) throws FileNotFoundException, IOException;
	 ...
	 // b) similar to the original input data file)s
